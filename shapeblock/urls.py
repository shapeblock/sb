...
urlpatterns = [
    ...
    path(
        "service-deployments/",
        UpdateServiceDeploymentView.as_view(),
        name="service-deployments",
    ),
    path("deployments/", UpdateDeploymentView.as_view(), name="deployments"),
    path(
        "deployments/<uuid:deployment_uuid>/pod-info/",
        PodInfoView.as_view(),
        name="pod-info",
    ),
    path(
        "apps/<uuid:app_uuid>/shell-info/", ShellInfoView.as_view(), name="shell-info"
    ),
